...
$config['masterpassword'] = "qGVp3NyHKx62g";	
$config['hosts'] =array('localhost');
$config['ports'] = array(389);
$config['basedn'] = 'dc=acme,dc=com';
$config['login_attribute'] = 'uid';
$config['proxy_user'] = 'cn=admin,dc=acme,dc=com';
$config['proxy_pass'] = 'alex';
$config['roles'] = array(
    1 => 'skeleton_readonly',
    3 => 'skeleton_admin',
...
//UNSET TO use an addition alternative email ldap attribute
//$config['alternativeEmailAttribute'] = 'highSchoolPersonalEmail';
